...
export default function ContractsPage() {
  ...
  async function sendForSignature(c) {
    ...
    if (c.staff_id) await notifyOne(c.staff_id,{type:'general',title:'📄 Contract Awaiting Your Signature',message:`"${c.title}" has been sent to you.`})
  ...
  async function submitCountersign() {
    ...
    if (selected.staff_id) {
      await notifyOne(selected.staff_id,{type:'general',title:'✅ Contract Fully Executed',
        message:`"${selected.title}" has been countersigned by ${mgmtSigner==='alex'?'Alex':'CJ'}. Your contract is now fully executed.`})
            ...
            <div style={{display:'flex',flexDirection:'column',gap:10,overflowY:'auto'}}>
              ...
              <div style={{background:'var(--white)',border:'1px solid var(--border)',borderRadius:13,padding:'14px'}}>
                ...
                <div style={{marginBottom:8}}>
                  ...
                  <input style={{...iStyle,padding:'6px 9px',fontSize:11}} value={builderForm.company_name} onChange={e=>setBuilderForm(p=>({...p,company_name:e.target.value}))}/>
                </div>
                <div style={{marginBottom:8}}>
                  <label style={lStyle}>Address Line 1</label>
                  <input style={{...iStyle,padding:'6px 9px',fontSize:11}} value={builderForm.address_line1} onChange={e=>setBuilderForm(p=>({...p,address_line1:e.target.value}))}/>
                </div>
                <div style={{marginBottom:8}}>
                  <label style={lStyle}>Address Line 2</label>
                  <input style={{...iStyle,padding:'6px 9px',fontSize:11}} value={builderForm.address_line2} onChange={e=>setBuilderForm(p=>({...p,address_line2:e.target.value}))}/>
                </div>
                <div style={{marginBottom:10}}>
                  <label style={lStyle}>Address Line 3</label>
                  <input style={{...iStyle,padding:'6px 9px',fontSize:11}} value={builderForm.address_line3} onChange={e=>setBuilderForm(p=>({...p,address_line3:e.target.value}))}/>
                </div>
                <div>
              ...
              <div style={{overflowY:'auto',padding:'16px'}}>
                ...
                <div style={{marginBottom:12}}>
                  ...
                  <textarea value={clauseForm.content} onChange={e=>setClauseForm(p=>({...p,content:e.target.value}))}
                    placeholder="Use <strong>, <ul>, <li>, <p> tags…"
